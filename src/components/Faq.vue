...
:root {
    ...
    /* FAQ Q&A */
    --faq-question-header-padding: 1rem;
    --faq-question-header-font-size: 1rem;
    ...
    --faq-question-body-padding: 1rem;
}
</style>