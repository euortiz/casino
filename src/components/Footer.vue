...
<template>
  <div class="bg-cinza">
    <div class="flexCenter flex-col">
      ...
      <div class="flex flex-col sm:flex-row gap-5 w-full h-full">

        <div class="bg-purple-900 flexCenter flex-col p-10 sm:w-1/4 border-r border-gray-400">
          <img src="../assets/navbar/logo.svg" alt="Casino Logo" class="w-20 h-20">
          <img src="../assets/footer/securesite.svg" class="w-[100px] flex">
        </div>
